...
if TYPE_CHECKING:
    ...
    from versa.abc import MessageableChannel
    from versa.guild import Guild
    from versa.member import Member
    from versa.state import ConnectionState
    from versa.user import ClientUser, User
    from versa.voice_client import VoiceProtocol
...
class Context(versa.abc.Messageable, Generic[BotT]):
    ...
    This class implements the :class:`~versa.abc.Messageable` ABC.
    ...
    async def _get_channel(self) -> versa.abc.Messageable:
        return self.channel
    ...
    def author(self) -> Union[User, Member]:
        """Union[:class:`~versa.User`, :class:`.Member`]:
    ...
    @versa.utils.copy_doc(Message.reply)
