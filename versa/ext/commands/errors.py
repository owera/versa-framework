...
from versa.errors import ClientException, DiscordException

if TYPE_CHECKING:
    from inspect import Parameter

    from versa.abc import GuildChannel
    from versa.threads import Thread
...
class CommandError(DiscordException):
    ...
    This inherits from :exc:`versa.DiscordException`.
...
class ConversionError(CommandError):
    ...
    Attributes
    ----------
    converter: :class:`versa.ext.commands.Converter`
...
class CommandRegistrationError(ClientException):
    ...
    This inherits from :exc:`versa.ClientException`
...
class TooManyFlags(FlagError):
    ...
    Attributes
    ----------
    flag: :class:`~versa.ext.commands.Flag`
