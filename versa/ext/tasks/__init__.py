...
import versa
from versa.backoff import ExponentialBackoff
from versa.utils import MISSING, utcnow
...
class SleepHandle:
    ...
    def __init__(self, dt: datetime.datetime, *, loop: asyncio.AbstractEventLoop) -> None:
        ...
        relative_delta = versa.utils.compute_timedelta(dt)
...
class Loop(Generic[LF]):
    ...
    def __init__(
        ...
        self._valid_exception = (
            OSError,
            versa.GatewayNotFound,
            versa.ConnectionClosed,
            aiohttp.ClientError,
    ...
    def add_exception_type(self, *exceptions: Type[BaseException]) -> None:
        ...
        :meth:`versa.Client.connect`\, which includes a lot of internet disconnection
        errors.
    ...
    def before_loop(self, coro: FT) -> FT:
        ...
        such as :meth:`versa.Client.wait_until_ready`.
...
def loop(
    *,
    ...
    reconnect: :class:`bool`
        ...
        one used in :meth:`versa.Client.connect`.
