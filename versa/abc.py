...
class User(Snowflake, Protocol):
    ...
    - :class:`~versa.User`
    - :class:`~versa.ClientUser`
    - :class:`~versa.Member`

    This ABC must also implement :class:`~versa.abc.Snowflake`.
...
class PrivateChannel(Snowflake, Protocol):
    ...
    - :class:`~versa.DMChannel`
    - :class:`~versa.GroupChannel`

    This ABC must also implement :class:`~versa.abc.Snowflake`.

    Attributes
    ----------
    me: :class:`~versa.ClientUser`
...
class GuildChannel:
    ...
    - :class:`~versa.TextChannel`
    - :class:`~versa.VoiceChannel`
    - :class:`~versa.CategoryChannel`
    - :class:`~versa.StageChannel`
    - :class:`~versa.ForumChannel`
    ...
    def changed_roles(self) -> List[Role]:
        """List[:class:`~versa.Role`]: Returns a list of roles that have been overridden from
        their default values in the :attr:`~versa.Guild.roles` attribute."""
        ret = []
        g = self.guild
    ...
    def overwrites_for(self, obj: Union[Role, User]) -> PermissionOverwrite:
        ...
        Parameters
        ----------
        obj: Union[:class:`~versa.Role`, :class:`~versa.abc.User`]
            The role or user denoting
            whose overwrite to get.

        Returns
        -------
        :class:`~versa.PermissionOverwrite`
    ...
    def overwrites(self) -> Dict[Union[Role, Member], PermissionOverwrite]:
        ...
        can be either a :class:`~versa.Role` or a :class:`~versa.Member` and the value is the
        overwrite as a :class:`~versa.PermissionOverwrite`.

        Returns
        -------
        Dict[Union[:class:`~versa.Role`, :class:`~versa.Member`], :class:`~versa.PermissionOverwrite`]
        ...
        for ow in self._overwrites:
            ...
            # i.e. adding versa.Object to the list of it
    ...
    def category(self) -> Optional[CategoryChannel]:
        """Optional[:class:`~versa.CategoryChannel`]: The category this channel belongs to.
    ...
    def permissions_for(self, obj: Union[Member, Role], /) -> Permissions:
        """Handles permission resolution for the :class:`~versa.Member`
        or :class:`~versa.Role`.
        ...
        If a :class:`~versa.Role` is passed, then it checks the permissions
        ...
        Parameters
        ----------
        obj: Union[:class:`~versa.Member`, :class:`~versa.Role`]
    ...
    async def delete(self, *, reason: Optional[str] = None) -> None:
        ...
        You must have :attr:`~versa.Permissions.manage_channels` permission to use this.
    ...
    async def set_permissions(
        ...
        **kwargs: Any,
        ...
        The ``target`` parameter should either be a :class:`~versa.Member` or a
        :class:`~versa.Role` that belongs to guild.

        The ``overwrite`` parameter, if given, must either be ``None`` or
        :class:`~versa.PermissionOverwrite`. For convenience, you can pass in
        keyword arguments denoting :class:`~versa.Permissions` attributes. If this is
        ...
        You must have the :attr:`~versa.Permissions.manage_roles` permission to use this.
        ...
        Using :class:`~versa.PermissionOverwrite` ::

            overwrite = versa.PermissionOverwrite()
        ...
        Parameters
        ----------
        target: Union[:class:`~versa.Member`, :class:`~versa.Role`]
            The member or role to overwrite permissions for.
        overwrite: Optional[:class:`~versa.PermissionOverwrite`]
        ...
        ~versa.InvalidArgument
            The overwrite parameter invalid or the target type was not
            :class:`~versa.Role` or :class:`~versa.Member`.
        """
    ...
    async def clone(self, *, name: Optional[str] = None, reason: Optional[str] = None) -> Self:
        ...
        You must have the :attr:`~versa.Permissions.manage_channels` permission to
        do this.
    ...
    async def move(self, **kwargs) -> None:
        ...
        before: :class:`~versa.abc.Snowflake`
            The channel that should be before our current channel.
            This is mutually exclusive with ``beginning``, ``end``, and ``after``.
        after: :class:`~versa.abc.Snowflake`
        ...
        category: Optional[:class:`~versa.abc.Snowflake`]
    ...
    async def create_invite(
        ...
        *,
        ...
        You must have the :attr:`~versa.Permissions.create_instant_invite` permission to
        do this.
    ...
    async def invites(self) -> List[Invite]:
        ...
        You must have :attr:`~versa.Permissions.manage_channels` to get this information.
...
class Messageable:
    ...
    - :class:`~versa.User`
    - :class:`~versa.Member`
    - :class:`~versa.ext.commands.Context`
    - :class:`~versa.Thread`
    """
    ...
    async def send(
        ...
        *,
        ...
        single :class:`~versa.File` object. To upload multiple files, the ``files``
        parameter should be used with a :class:`list` of :class:`~versa.File` objects.
        **Specifying both parameters will lead to an exception**.

        To upload a single embed, the ``embed`` parameter should be used with a
        single :class:`~versa.Embed` object. To upload multiple embeds, the ``embeds``
        parameter should be used with a :class:`list` of :class:`~versa.Embed` objects.
        **Specifying both parameters will lead to an exception**.
        ...
        embed: :class:`~versa.Embed`
            The rich embed for the content.
        file: :class:`~versa.File`
            The file to upload.
        files: List[:class:`~versa.File`]
        ...
        allowed_mentions: :class:`~versa.AllowedMentions`
            Controls the mentions being processed in this message. If this is
            passed, then the object is merged with :attr:`~versa.Client.allowed_mentions`.
            The merging behaviour only overrides attributes that have been explicitly passed
            to the object, otherwise it uses the attributes set in :attr:`~versa.Client.allowed_mentions`.
            If no object is passed at all then the defaults given by :attr:`~versa.Client.allowed_mentions`
            are used instead.

            .. versionadded:: 1.4

        reference: Union[:class:`~versa.Message`, :class:`~versa.MessageReference`, :class:`~versa.PartialMessage`]
            A reference to the :class:`~versa.Message` to which you are replying, this can be created using
            :meth:`~versa.Message.to_reference` or passed directly as a :class:`~versa.Message`. You can control
            whether this mentions the author of the referenced message using the :attr:`~versa.AllowedMentions.replied_user`
            attribute of ``allowed_mentions`` or by setting ``mention_author``.

            .. versionadded:: 1.6

        mention_author: Optional[:class:`bool`]
            If set, overrides the :attr:`~versa.AllowedMentions.replied_user` attribute of ``allowed_mentions``.

            .. versionadded:: 1.6
        view: :class:`versa.ui.View`
            A Discord UI View to add to the message.
        embeds: List[:class:`~versa.Embed`]
            A list of embeds to upload. Must be a maximum of 10.

            .. versionadded:: 2.0
        stickers: Sequence[Union[:class:`~versa.GuildSticker`, :class:`~versa.StickerItem`]]
        ...
        ~versa.InvalidArgument
            ...
            or the ``reference`` object is not a :class:`~versa.Message`,
            :class:`~versa.MessageReference` or :class:`~versa.PartialMessage`.
    ...
    async def fetch_message(self, id: int, /) -> Message:
        ...
        Retrieves a single :class:`~versa.Message` from the destination.
    ...
    def history(
        ...
        *,
        ...
        """Returns an :class:`~versa.AsyncIterator` that enables receiving the destination's message history.

        You must have :attr:`~versa.Permissions.read_message_history` permissions to use this.
        ...
        before: Optional[Union[:class:`~versa.abc.Snowflake`, :class:`datetime.datetime`]]
            Retrieve messages before this date or message.
            If a datetime is provided, it is recommended to use a UTC aware datetime.
            If the datetime is naive, it is assumed to be local time.
        after: Optional[Union[:class:`~versa.abc.Snowflake`, :class:`datetime.datetime`]]
            Retrieve messages after this date or message.
            If a datetime is provided, it is recommended to use a UTC aware datetime.
            If the datetime is naive, it is assumed to be local time.
        around: Optional[Union[:class:`~versa.abc.Snowflake`, :class:`datetime.datetime`]]
    ...
    async def connect(
        ...
        *,
        ...
        cls: Type[:class:`VoiceProtocol`]
            A type that subclasses :class:`~versa.VoiceProtocol` to connect with.
            Defaults to :class:`~versa.VoiceClient`.

        Raises
        ------
        asyncio.TimeoutError
            Could not connect to the voice channel in time.
        ~versa.ClientException
            You are already connected to a voice channel.
        ~versa.opus.OpusNotLoaded
            The opus library has not been loaded.

        Returns
        -------
        :class:`~versa.VoiceProtocol`
