...
class WebhookMessage(Message):
    ...
    This inherits from :class:`versa.Message` with changes to
...
class Webhook(BaseWebhook):
    ...
    async def send(
        ...
        *,
        ...
        view: :class:`versa.ui.View`
            ...
            .. versionadded:: 2.0
        thread: :class:`~versa.abc.Snowflake`
    ...
    async def fetch_message(self, id: int) -> WebhookMessage:
        ...
        Retrieves a single :class:`~versa.WebhookMessage` owned by this webhook.
