...
class Button(Item[V]):
    ...
    def style(self) -> ButtonStyle:
        """:class:`versa.ButtonStyle`: The style of the button."""
...
def button(
    *,
    ...
    the :class:`versa.ui.View`, the :class:`versa.ui.Button` being pressed and
    the :class:`versa.Interaction` you receive.
