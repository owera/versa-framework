...
class TextChannel(abc.Messageable, abc.GuildChannel, Hashable, PinsMixin):
    ...
    async def create_thread(
        ...
        *,
        ...
        To create a public thread, you must have :attr:`~versa.Permissions.create_public_threads`.
        For a private thread, :attr:`~versa.Permissions.create_private_threads` is needed instead.
    ...
    def archived_threads(
        ...
        *,
        ...
        """Returns an :class:`~versa.AsyncIterator` that iterates over all archived threads in the guild.
...
class ForumChannel(abc.GuildChannel, Hashable):
    ...
    async def create_thread(
        ...
        *,
        ...
        :attr:`~versa.Permissions.create_public_threads`.
        For a private thread, :attr:`~versa.Permissions.create_private_threads`
        is needed instead.
        ...
        embed: Optional[:class:`~versa.Embed`]
            The rich embed for the content.
        embeds: Optional[List[:class:`~versa.Embed`]]
            A list of rich embeds for the content.
        file: :class:`~versa.File`
            The file to upload.
        files: Optional[List[:class:`~versa.File`]]
            A list of files to upload. Must be a maximum of 10.
        nonce: Optional[:class:`int`]
            The nonce to use for sending this message. If the message was successfully sent,
            then the message will have a nonce with this value.
        allowed_mentions: Optional[:class:`~versa.AllowedMentions`]
        ...
        view: Optional[:class:`~versa.ui.View`]
            The view to send with the message.
        stickers: Optional[Sequence[Union[:class:`~versa.GuildSticker`, :class:`~versa.StickerItem`]]]
