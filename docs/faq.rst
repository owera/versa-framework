...
Example code can be found in the `examples folder <https://github.com/owera/versa-framework/tree/master/examples>`_
in the repository.
...
`Check the background_task.py example. <https://github.com/owera/versa-framework/blob/master/examples/background_task.py>`_
