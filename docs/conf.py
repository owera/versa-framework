...
extlinks = {
    "issue": ("https://github.com/owera/versa-framework/issues%s", "GH-%s"),
    "dpyissue": ("https://github.com/Rapptz/discord.py/issues/%s", "GH-%s"),
}
...
branch = "master" if any(c in version for c in ("a", "b", "rc")) else "v" + version
...
resource_links = {
    "discord": "https://discord.gg/Fee6Kptq57",
    "issues": "https://github.com/owera/versa-framework/issues",
    "discussions": "https://discord.gg/ZSqV7CC2cr",
    "examples": f"https://github.com/owera/versa-framework/{branch}/examples",
}
...
def setup(app):
    if app.config.language == "ja":
        ...
        app.config.html_context["discord_invite"] = "https://discord.gg/Fee6Kptq57"
        app.config.resource_links["discord"] = "https://discord.gg/Fee6Kptq57"
