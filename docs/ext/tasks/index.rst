...
``versacord.ext.tasks`` -- asyncio.Task helpers
==============================================
...
The goal of this versacord extension is to abstract all these worries away from you.

Recipes
-------

A simple background task in a :class:`~versacord.ext.commands.Cog`:

.. code-block:: python3

    from versacord.ext import tasks, commands
...
.. code-block:: python3
    ...
    from versacord.ext import tasks
...
.. attributetable:: versacord.ext.tasks.Loop

.. autoclass:: versacord.ext.tasks.Loop()
    :members:
...
.. autofunction:: versacord.ext.tasks.loop
