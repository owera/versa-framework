...
class EphemeralCounter(versa.ui.View):
    # When this button is pressed, it will respond with a Counter view that will
    # give the button presser their own personal button they can press 5 times.
    @versa.ui.button(label="Click", style=versa.ButtonStyle.blurple)
    async def receive(self, button: versa.ui.Button, interaction: versa.Interaction):
